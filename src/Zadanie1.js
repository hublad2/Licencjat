let zad1DOM =
  ...
  '            <i class="fas fa-check mark-check-green inactive" id="green-mark-Zad111"></i>' +
  '            <i class="fas fa-times mark-check-red inactive" id="red-mark-Zad111"></i>' +
  "          </div>" +
  '          <div class="zadanie1_odp">' +
  "            <p>- Większa gęstość kulek niebieskich od białych.</p>" +
  '            <input type="checkbox" id="Zad112" />' +
  '            <i class="fas fa-check mark-check-green inactive" id="green-mark-Zad112"></i>' +
  '            <i class="fas fa-times mark-check-red inactive" id="red-mark-Zad112"></i>' +
  "          </div>" +
  '          <div class="zadanie1_odp">' +
  "            <p>- Dyfuzja cząsteczek cieczy.</p>" +
  '            <input type="checkbox" id="Zad113" />' +
  '            <i class="fas fa-check mark-check-green inactive" id="green-mark-Zad113"></i>' +
  '            <i class="fas fa-times mark-check-red inactive" id="red-mark-Zad113"></i>' +
  "          </div>" +
  ...
  "              W butelce znajdują się dwie ciecze o różnych gęstościach, dodatkowo nie mieszają się. Dzięki temu ciecz mniej gęsta wypływa do góry. Kulki są mniej gęste od gęstszej cieczy, ale bardziej gęste od mniej gęstej cieczy, dlatego znajdują się na granicy tych cieczy. Gęstości cieczy i kulek są w relacji: ciecz na dole > kulki niebieskie > kulki białe > ciecz na górze." +
  "            </p>" +
  "          </div>" +
