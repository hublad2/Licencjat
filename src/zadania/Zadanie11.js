var zad11DOM =
  ...
  '            <p id="Odp111" class="inactive-chekbox">Światło porusza się z prędkościa 300 tysięcy kilometrów na sekundę. Galileusz potrzebował dużo dokładniejszych narzędzi do pomiaru czasu i rejestrowania odsłonięcia przesłony. Gdyby prędkość światła była znacznie mniejsza, eksperyment Galileusza mógłby się powieść.</p>' +
  "          </div>" +
  "          <p>" +
